...
require (
	...
	github.com/ONSdigital/dp-cache v0.5.0 // indirect
...
tool (
	// This is required to mitigate [CVE-2025-27144] CWE-770: Allocation of Resources Without Limits or Throttling
